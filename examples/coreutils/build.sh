...
utilities=(true false echo cat wc pwd mkdir rmdir basename dirname head tail tee yes sleep uname printenv env nproc link unlink touch truncate mkfifo sync cp mv rm ln chmod readlink realpath chown chgrp stat ls arch logname whoami seq tac nl fold uniq cut comm tr)
