...
utilities=(true false echo cat wc pwd mkdir rmdir basename dirname head tail tee yes sleep uname printenv env nproc link unlink touch truncate mkfifo sync cp)
